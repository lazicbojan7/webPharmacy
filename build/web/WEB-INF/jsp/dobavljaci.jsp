 ...
 <%--linkovi za datatables:--%>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="dobavljaci">Dobavljaci</a></li>
      <li><a href="proizvodjaci">Proizvodjaci</a></li>
        <li><a href="kupci">Kupci</a></li>
         <li><a href="zaposleni">Zaposleni</a></li>
              ...
              <button type="button" id="show" class="btn btn-default">Dodaj novog dobavljaca</button>
              ...
              <c:otherwise>
                     ...
                     <form id="unos" action="potvrdadobavljac" method="post">
             <h3>Unesite potrebne podatke o novom dobavljacu</h3>
