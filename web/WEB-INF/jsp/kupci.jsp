    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="dobavljaci">Dobavljaci</a></li>
       <li><a href="proizvodjaci">Proizvodjaci</a></li>
        <li class="active"><a href="kupci">Kupci</a></li>
         <li><a href="zaposleni">Zaposleni</a></li>
              ...
              <button type="button" id="show" class="btn btn-default">Dodaj novog kupca</button>
              ...
              <c:otherwise>
                     ...
                     <form id="unos" action="potvrdakupac" method="post">
             <h3>Unesite potrebne podatke o novom kupcu</h3>
